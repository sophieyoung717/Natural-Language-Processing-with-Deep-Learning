...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_placeholder = tf.placeholder(dtype=tf.int32,shape=(None,Config.n_features))
        self.labels_placeholder = tf.placeholder(dtype=tf.float32,shape=(None,Config.n_classes))
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embedding_params = tf.Variable(self.pretrained_embeddings)
        embeddings = tf.nn.embedding_lookup(embedding_params,self.input_placeholder,partition_strategy='div')
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        InitW= xavier_weight_init()
        W = InitW((Config.n_features*Config.embed_size, Config.hidden_size))
        b1 = tf.Variable(tf.zeros((Config.hidden_size)))
        U = InitW((Config.hidden_size,Config.n_classes))
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss_l = tf.nn.softmax_cross_entropy_with_logits(labels=self.labels_placeholder, logits = pred)
